  ...
  return (
    <div className='max-w-lg p-3 mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <button className='p-2 font-semibold text-white uppercase rounded-lg bg-slate-700 hover:opacity-90 hover:font-bold disabled:opacity-75'>
          {loading ? 'Loading...' : 'Update'}
        </button>
      </form>
      <div className='flex justify-between mt-5'>
        <span onClick = {handleDeleteAccount} className='font-medium text-red-700 cursor-pointer'>Delete Account</span>
        <span onClick = {handleSignout} className='font-medium text-red-700 cursor-pointer'>Sign Out</span>
      </div>
